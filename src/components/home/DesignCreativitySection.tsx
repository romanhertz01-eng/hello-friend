      ...
      <motion.div variants={fadeUp} className="flex justify-center mb-6">
        <div className="inline-flex gap-1 p-1 rounded-xl bg-muted/50 dark:bg-[rgba(255,255,255,0.06)]">
          <button
            ...
            className={cn("px-5 py-2 rounded-[8px] text-sm cursor-pointer transition-all", tab === "photo" ? "text-foreground font-medium" : "text-muted-foreground")}
          ...
          <button
            ...
            className={cn("px-5 py-2 rounded-[8px] text-sm cursor-pointer transition-all", tab === "video" ? "text-foreground font-medium" : "text-muted-foreground")}
